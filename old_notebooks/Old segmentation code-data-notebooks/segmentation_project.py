...
def segmentation_mymethod(train_data_matrix, train_labels_matrix, test_data, task='brain'):
    ...
    predicted_brain = seg.segmentation_combined_atlas(all_labels_matrix)

    #Segment tissue with kNN
    k = 5
    ...
    predicted_knn[predicted_brain == 0] = 0
    predicted_labels = predicted_knn
    #!studentend
    #------------------------------------------------------------------#
